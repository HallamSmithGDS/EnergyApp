...
replacement_cost = []
cost_difference = []
annual_rate_increase = 1.05

if PaybackOn:
    for i in range(Years):
        current_year = (i+1)
        current_existing_cost = (TotalExistCost*(i + 1) * (i * annual_rate_increase))
        current_replace_cost = (((TotalReplaceCost * (i + 1)) * (i * annual_rate_increase)) + Purchase + Install)
